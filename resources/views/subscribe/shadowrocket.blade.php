...
<head>
	...
	<title>Shadowrocket 自动化配置</title>
    ...
    <div class="wrap">
        <div class="main">
			<div class="topbread" style="margin-bottom: 20px;">
		    	<div class="container">
                  <h1 class="text-center">Shadowrocket 自动化配置</h1>
		    	</div>
			</div>
			<div style="margin-top: 30px; margin-bottom: 20px;">
		        <div style="text-align:center;">
		            ...
		            <div style="padding-top:20px;">
		                <span id="checkinfo">
							<p style="color:red;">这是您的专属页面，请勿传播本页面</p>
							<p style="color:red;">否则将导致账号异常被封号</p>
							<p style="color:blue; padding-bottom:15px; font-size:14px;">如果弹出提示请'允许'或'Allow'</p>
		                    <a href="{{$sub}}" class="btn btn-success btn-lg btn-circle">第1步：载入账号</a><br /><br />
