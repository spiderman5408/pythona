                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            @else
                                                ...
                                                <a href="{{$node->v2_scheme}}" class="btn purple" style="display: block; width: 100%;margin-top: 10px;">打开V2Ray</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                @if($node->type == 1)
                                                    @if($node->compatible)
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div style="text-align: center;"><a id="download_qrcode_ss_img_{{$node->id}}">下载</a></div>
                                                        </div>
                                                    @else
                                                        <div class="col-md-12">
                                                            <div id="qrcode_ssr_img_{{$node->id}}" style="text-align: center;"></div>
                                                ...
                                                @else
                                                    <div class="col-md-12">
                                                        ...
                                                        <div style="text-align: center;"><a id="download_qrcode_v2_img_{{$node->id}}">下载</a></div>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
