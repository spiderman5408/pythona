    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item {{in_array(Request::path(), ['ticket/ticketList', 'ticket/addTicket', 'ticket/replyTicket']) ? 'active open' : ''}}">
		...
		<li class="nav-item {{in_array(Request::path(), ['shop/goodsList', 'shop/addGoods']) || Request::segment('2') == 'editGoods' ? 'active open' : ''}}">
                    <a href="/shop/goodsList" class="nav-link nav-toggle">
                        <i class="fa fa-shopping-cart"></i>
                        <span class="title">商品管理</span>
                    </a>
                </li>
                <li class="nav-item {{in_array(Request::path(), ['admin/orderList', 'payment/callbackList']) ? 'active open' : ''}}">
                ...
                <li class="nav-item {{in_array(Request::path(), ['admin/userList', 'admin/addUser', 'admin/editUser', 'admin/userOrderList', 'admin/userBalanceLogList', 'admin/userTrafficLogList', 'admin/userRebateList', 'admin/userBanLogList', 'admin/userMonitor', 'admin/onlineIPMonitor', 'subscribe/subscribeList', 'admin/userSubscribeLog']) || in_array(Request::segment(2), ['export', 'userMonitor']) ? 'active open' : ''}}">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item {{in_array(Request::path(), ['admin/userList', 'admin/addUser', 'admin/editUser', 'admin/userMonitor']) || in_array(Request::segment(2), ['export', 'userMonitor']) ? 'active open' : ''}}">
                        ...
                        <li class="nav-item {{in_array(Request::path(), ['subscribe/subscribeList', 'admin/userSubscribeLog']) ? 'active open' : ''}}">
                ...
                <li class="nav-item {{in_array(Request::path(), ['admin/nodeList', 'admin/addNode', 'admin/editNode', 'admin/groupList', 'admin/addGroup', 'admin/editGroup', 'admin/nodeRealTimeStatus', 'admin/nodeMonitor', 'admin/accessList']) ? 'active open' : ''}}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="fa fa-list-alt"></i>
                ...
                <li class="nav-item {{in_array(Request::path(), ['marketing/emailList', 'marketing/pushList', 'admin/emailLog']) ? 'active open' : ''}}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <li class="nav-item {{in_array(Request::path(), ['permission/permissionList', 'permission/addPermission', 'permission/editPermission', 'permission/roleList', 'permission/addRole', 'permission/editRole', 'permission/assignPermission', 'permission/masterList', 'permission/assignRole']) ? 'active open' : ''}}">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="fa fa-users"></i>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item {{in_array(Request::path(), ['permission/masterList', 'permission/assignRole']) ? 'active open' : ''}}">
                ...
                <li class="nav-item {{in_array(Request::path(), ['admin/convert', 'admin/import', 'admin/trafficLog', 'admin/labelList', 'sensitiveWords/list', 'sensitiveWords/add']) ? 'active open' : ''}}">
                    <a href="javascript:;" class="nav-link nav-toggle">
