                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <select class="form-control" name="pay_way" id="pay_way" onchange="doSearch()">
                                    ...
                                    <option value="2" @if(Request::get('pay_way') == '2') selected @endif>码支付</option>
                                    <option value="4" @if(Request::get('pay_way') == '4') selected @endif>支付宝国际</option>
                                    <option value="5" @if(Request::get('pay_way') == '5') selected @endif>当面付</option>
                                </select>
                            </div>
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                    ...
                                    @else
                                        @foreach($orderList as $order)
                                            <tr>
                                                ...
                                                <td> <a href="/admin/orderList?order_sn={{$order->order_sn}}">{{$order->order_sn}}</a> </td>
                                                ...
                                                <td> ￥{{$order->amount}} </td>
                                                <td> <span class="label label-info"> {{$order->pay_way_label}} </span> </td>
