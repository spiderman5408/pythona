...
@section('script')
    <script type="text/javascript">
        ...
        function addSensitiveWords()
        {
            ...
            $.post("/sensitiveWords/add", {_token:'{{csrf_token()}}', type:type, words:words}, function(ret) {
        ...
        function doSearch() {
            ...
            window.location.href = '/sensitiveWords/list?type=' + type +'&words=' + words;
        }

        // 重置
        function doReset() {
            window.location.href = '/sensitiveWords/list';
        }
    </script>
@endsection
