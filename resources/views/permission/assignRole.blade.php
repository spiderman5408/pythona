            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-dark">授权(分配)角色</span>
                        </div>
                        <div class="actions"></div>
                    </div>
                    <div class="portlet-body form">
                        <form action="/permission/assignRole" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                            <div class="form-body">
