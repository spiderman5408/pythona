                        ...
                        <form action="/permission/editPermission" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                            <div class="form-body">
                                <div class="form-group">
                                    <label for="type" class="control-label col-md-3">守卫</label>
                                    <div class="col-md-6">
                                        <div class="mt-radio-inline">
                                            <label class="mt-radio">
                                                <input type="radio" name="guard_name" value="web" checked> WEB
                                                <span></span>
                                            </label>
                                            <label class="mt-radio">
                                                <input type="radio" name="guard_name" value="api" disabled="disabled"> API
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">行为</label>
                                    <div class="col-md-6">
