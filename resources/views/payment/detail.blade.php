        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                <div class="alert alert-info" style="text-align: center;">
                    请使用<strong style="color:red;">支付宝</strong>扫描如下二维码
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-scrollable">
                            <table class="table table-hover table-light">
                                ...
                                @if($payment->order->goods->type == 3)
                                    <tr>
                                        <td align="right">实际到账：</td>
                                        <td align="left">{{$payment->order->goods->amount}} 元</td>
                                    </tr>
                                @else
                                    <tr>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            // 支付宝直接跳转支付
            @if(\App\Components\Helpers::systemConfig()['payment_gateway'] == '4')
