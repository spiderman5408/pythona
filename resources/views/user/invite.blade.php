                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <div class="alert alert-info">
                                ...
                                {{trans('home.invite_code_tips1')}} <strong> {{Auth::user()->invite_num}} </strong> {{trans('home.invite_code_tips2', ['days' => \App\Components\Helpers::systemConfig()['user_invite_days']])}}
                            </div>
                            <button type="button" class="btn blue" onclick="makeInvite()" @if(!Auth::user()->invite_num) disabled @endif> {{trans('home.invite_code_button')}} </button>
                        </div>
                    </div>
                </div>
            </div>
