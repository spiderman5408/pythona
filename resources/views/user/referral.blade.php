                                ...
                                @else
                                    @foreach($referralUserList as $key => $vo)
                                        <tr class="odd gradeX">
                                            ...
                                            <td style="width: 65%;"> {{str_replace(mb_substr($vo->username, 3, 4), "****", $vo->username)}} </td>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-7">
                                <div class="dataTables_paginate paging_bootstrap_full_number pull-right">
                                    {{ $referralLogList->appends(array_except(Request::query(), 'log_page'))->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="dataTables_paginate paging_bootstrap_full_number pull-right">
                                    {{ $referralApplyList->appends(array_except(Request::query(), 'apply_page'))->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
