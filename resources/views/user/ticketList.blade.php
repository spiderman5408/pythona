            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <div class="btn-group">
                                <button class="btn blue" data-toggle="modal" data-target="#add_ticket_modal"> {{trans('home.ticket_table_new_button')}} </button>
                            </div>
                        </div>
                    </div>
                                ...
                                @else
                                    @foreach($ticketList as $ticket)
                                        <tr class="odd gradeX">
                                            ...
                                            <td style="width: 65%;"> <a href="/replyTicket?id={{$ticket->id}}" target="_blank">{{$ticket->title}}</a> </td>
                                            <td style="width: 20%;">
                                                @if ($ticket->status == 0)
