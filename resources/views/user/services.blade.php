                                                        ...
                                                        <div class="price-column-container border-active" style="margin-bottom: 20px;">
                                                            ...
                                                            <div class="price-table-content">
                                                                ...
                                                                <div class="row mobile-padding">
                                                                    ...
                                                                    <div class="col-xs-9 text-left mobile-padding">授予等级：<span style="color:red;">{{$goods->level_label}}</span></div>
                                                                </div>
                                                                @if($goods->speed >= 0)
                                                                    <div class="row mobile-padding">
                                                                        <div class="col-xs-3 text-right mobile-padding">
                                                                        ...
                                                                        <div class="col-xs-9 text-left mobile-padding">授予速率：<span style="color:red;">{{formatNetSpeed($goods->speed)}}</span></div>
                                                                    </div>
                                                                @endif
                                                                @if($goods->invite_num)
                                                                    <div class="row mobile-padding">
                                                                        ...
                                                                        <div class="col-xs-9 text-left mobile-padding">赠邀请码：{{$goods->invite_num}} 枚</div>
                                                                    </div>
                                                                @endif
                                                                <div class="row mobile-padding">
                                                                    <div class="col-xs-3 text-right mobile-padding">
                                                            ...
                                                            <div class="price-table-footer">
                                                                <button type="button" class="btn {{$goods->color}} {{$goods->is_hot ? '' : 'btn-outline'}} uppercase price-button" onclick="buy('{{$goods->id}}')">{{trans('home.service_buy_button')}}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                                            ...
                                                            <div class="price-table-content">
                                                                ...
                                                                @if($goods->invite_num)
                                                                    <div class="row mobile-padding">
                                                                        ...
                                                                        <div class="col-xs-9 text-left mobile-padding">赠邀请码：<span style="color:red;">{{$goods->invite_num}}枚</span></div>
                                                                    </div>
                                                                @endif
                                                                <div class="row mobile-padding">
                                                                    <div class="col-xs-3 text-right mobile-padding">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        // 充值
        function charge() {
            var charge_type = $("#charge_type option:selected").val();
